...
public sealed class MetalSpawnActor : Actor<MetalSpawnActor>
{
    public override ActorType Type => ActorType.MetalSpawn;
    ...
    public override long DecayTimer { get; set; } = 10000;
